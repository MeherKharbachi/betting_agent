# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/Patching/03_monkey_patching.ipynb.

# %% auto 0
__all__ = ['torch_api', 'append', 'add_last_step', 'train_single_env', 'fit_online']

# %% ../../nbs/Patching/03_monkey_patching.ipynb 3
...
# %% ../../nbs/Patching/03_monkey_patching.ipynb 7
def torch_api(
...
# %% ../../nbs/Patching/03_monkey_patching.ipynb 10
def append(
    self,
...
# %% ../../nbs/Patching/03_monkey_patching.ipynb 11
def add_last_step(
    self,
...
# %% ../../nbs/Patching/03_monkey_patching.ipynb 14
...
# %% ../../nbs/Patching/03_monkey_patching.ipynb 15
def fit_online(
    self,
    env: gym.Env,  # Gym-like environment.
    buffer: ReplayBuffer,  # Replay buffer.
